...
figname = 'BB84tfractionalplot.eps'
...
curve1 = ax.semilogx(
    blockList1, keyrate1[0] / keyrate1[0], 'ro', linewidth=2, markersize=8)
curve2 = ax.semilogx(blockList1, keyrate1[1] / keyrate1[0], color=(1, 0.5, 0), marker='*', linestyle='none',
                     linewidth=2, markersize=8)
curve3 = ax.semilogx(
    blockList1, keyrate1[2] / keyrate1[0], 'c^', linewidth=2, markersize=8)
curve4 = ax.semilogx(
    blockList1, keyrate1[3] / keyrate1[0], 'bs', linewidth=2, markersize=7)
curve5 = ax.semilogx(
    blockList1, keyrate1[4] / keyrate1[0], 'g>', linewidth=2, markersize=8)

plt.xlabel(r'Number of signals')
plt.ylabel('KPS($\zeta_{t}$)/KPS($\zeta_{t}=0)$')
