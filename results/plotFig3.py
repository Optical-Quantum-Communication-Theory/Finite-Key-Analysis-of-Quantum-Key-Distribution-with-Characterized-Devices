...
figname = 'BB84compthm-revised.eps'

filename1 = 'bb84fig2curve2.mat'
...
# If its value is too small, your legend may have overlaps with your curves.
...
ax.legend(curves, ['Theorem 5', 'Theorem 15'], frameon=False, loc='best')
